...
echo 'nohup btcd --$1 -d debug --committeesize=$2 --latency=$3 --nostalldetect -u USER -P PASS  --listen=0.0.0.0:18555 --rpclisten=0.0.0.0:18556 --miningaddr=$4 ${@:5} > /home/ec2-user/main.log 2>&1 &' >> /home/ec2-user/main.sh
